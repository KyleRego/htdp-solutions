...
(define 10-CENTS 0.1)
(define ATTENDANCE-CHANGE (/ CHANGE-IN-ATTENDANCE-PER-10-CENTS 10-CENTS))
(define FIXED-COST-PER-SHOW 180)
(define COST-PER-ATTENDEE 0.04)

(define (attendees ticket-price)
  (- ATTENDANCE-AT-5-DOLLARS (* (- ticket-price TICK-PRICE) ATTENDANCE-CHANGE)))

(define (revenue ticket-price)
  (* ticket-price (attendees ticket-price)))

(define (cost ticket-price)
  (+ FIXED-COST-PER-SHOW (* COST-PER-ATTENDEE (attendees ticket-price))))
