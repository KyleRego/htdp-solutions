...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname exercise193) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; Posn NELoP -> NELoP
; adds the posn to the end of the list of positions
(check-expect (add-to-end (make-posn 10 10) triangle-p)
              (list
               (make-posn 20 10)
               (make-posn 20 20)
               (make-posn 30 20)
