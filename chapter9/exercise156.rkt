...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise156) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; exercise 156
(require 2htdp/image)
